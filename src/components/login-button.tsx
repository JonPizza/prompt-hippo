...
export default function LoginButton(props: { nextUrl?: string, google?: boolean }) {
  ...
  if (!props.google) {
    ...
    return (
      <button className="p-6 text-black flex flex-row w-full mx-auto border border-bg-slate-400 rounded-lg justify-center items-center py-2 space-x-4 mb-2 hover:bg-gray-100 duration-200">
